...
export default function Input({labelText,type}) {
  ...
  return (
    <div className=" relative">
      <label htmlFor="" className={`" absolute  top-[50%]  font-light duration-300  ease-linear transform transition-all -translate-y-[50%] ${label ? " text-xs top-[10%] " : " top-[50%] text-[#9e9e9e]   "} "`}>
        {labelText}
      </label>
